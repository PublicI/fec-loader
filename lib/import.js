var _ = require('lodash'),
    ...
    switcher = require('switch-stream'),
        ...
        openStream(function (err,stream) {
            ...
            var dbStream = dbStreamer({
                    dbConnString: process.env.DB_DRIVER + '://' +
                        ...
                        process.env.DB_NAME,
                    tableName: models.fec_filing.tableName,
                    columns: Object.keys(models.fec_filing.attributes)
            });
/*
                    ...
                    .pipe(through2.obj(function (row, enc, next) {
                        ...
                        if (typeof row.model !== 'undefined') {
                            if (dbStream.tableName !== row.model.tableName) {
                                dbStream.setModel(row.model.tableName,Object.keys(row.model.attributes).filter(function (value) {
                                    return value !== 'id';
                                }));
                            }
